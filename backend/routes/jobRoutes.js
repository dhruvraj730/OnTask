...
const { getJobs, createJob, getMyJobs, getJobById, scheduleInterview, hireApplicant, rejectApplicant, addJobUpdate, verifyJobUpdate, applyForJob, releasePayment, proposeNegotiation, respondToNegotiation, createDirectHire } = require('../controllers/jobController');
...
router.get('/', getJobs);
router.post('/direct-hire', protect, checkSubscription, createDirectHire);
...
router.post('/:id/update', protect, upload.single('work_image'), addJobUpdate);
